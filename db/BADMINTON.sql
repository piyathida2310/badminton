CREATE TYPE public.role_enum AS ENUM ('ORGANIZER', 'PLAYER');

CREATE TYPE public.play_type_enum AS ENUM ('SINGLE', 'DOUBLE');

CREATE TYPE public.hand_type_enum AS ENUM ('BG', 'NB', 'N', 'S', 'P_MINUS', 'P_PLUS');

CREATE TYPE public.payment_status_enum AS ENUM ('PENDING', 'CONFIRMED', 'REJECTED');

CREATE TYPE public.evaluation_status_enum AS ENUM ('WAITING', 'PASSED', 'FAILED');

CREATE TYPE public.match_status_enum AS ENUM ('PENDING', 'RUNNING', 'FINISHED', 'CANCELLED');

CREATE TYPE public.cancellation_status_enum AS ENUM ('REQUESTED', 'REFUNDED', 'REJECTED');

CREATE TYPE public.match_stage_enum AS ENUM ('UPPER', 'LOWER', 'GRAND_FINAL', 'THIRD_PLACE');

CREATE TYPE public.match_slot_enum AS ENUM ('P1', 'P2');
