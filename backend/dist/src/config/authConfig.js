...
const defaultAccessExpires = '30m';
const defaultRefreshExpires = '7d';
exports.authConfig = {
    refreshToken: {
        expiryDays: 7,
        saltRounds: 12,
    ...
    jwt: {
        access: {
            ...
            expiresIn: process.env.JWT_ACCESS_EXPIRES || defaultAccessExpires,
        },
        refresh: {
            secret: process.env.JWT_REFRESH_SECRET || 'super-refresh-secret-32+',
            expiresIn: process.env.JWT_REFRESH_EXPIRES || defaultRefreshExpires,
        },
