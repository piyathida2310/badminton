...
export default function About() {
  ...
  const features = [
    { title: t('about.features.easyManage'), desc: t('about.features.easyManageDesc'), icon: <Calendar className="w-8 h-8 text-[#194185]" /> },
    { title: t('about.features.realtime'), desc: t('about.features.realtimeDesc'), icon: <TrendingUp className="w-8 h-8 text-[#194185]" /> },
    { title: t('about.features.responsive'), desc: t('about.features.responsiveDesc'), icon: <MonitorSmartphone className="w-8 h-8 text-[#194185]" /> },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-20 max-w-7xl mx-auto">
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#194185]/5 rounded-bl-full -z-10 transition-transform group-hover:scale-110"></div>
          <div className="flex items-center gap-4">
            <div className="p-3 bg-[#194185]/10 rounded-2xl text-[#194185]">
        ...
        >
          ...
          <ul className="text-gray-600 space-y-4">
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-6 h-6 text-[#194185] flex-shrink-0 mt-0.5" />
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-32 max-w-7xl mx-auto">
        {features.map((feature, idx) => (
          ...
          >
            <div className="p-4 bg-[#194185]/5 rounded-full group-hover:scale-110 group-hover:bg-[#194185]/10 transition-all duration-300">
              {feature.icon}
            </div>
      ...
      <section className="mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 mb-24 max-w-4xl mx-auto">
          {teamMembers.map((person, idx) => (
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-32 bg-[#194185]/5 -z-10 group-hover:h-36 transition-all duration-500"></div>
              
              <div className="relative mb-6">
                <div className="absolute -inset-1 bg-[#194185]/20 rounded-full blur opacity-30 group-hover:opacity-60 transition duration-500"></div>
                <Image
                  src={person.img}
                  alt={person.name}
                  width={140}
              ...
              <div className="px-4 py-1.5 bg-[#194185]/10 text-[#194185] font-semibold text-sm rounded-full mb-4">
                {person.role}
              </div>
              <a
                href={`mailto:${person.email}`}
                className="text-slate-500 hover:text-[#2ED3B7] hover:underline transition-colors font-medium"
              >
                {person.email}
              </a>
            </motion.div>
        ...
        <div className="text-center">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-[#194185] text-white px-10 py-4 rounded-full shadow-lg hover:bg-[#2ED3B7] hover:-translate-y-1 transition-all duration-300 font-bold text-lg"
          >
            {t('about.registerNow')}
          </motion.a>
        </div>
