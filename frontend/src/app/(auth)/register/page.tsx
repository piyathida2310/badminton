    ...
    try {
      ...
      if (err.response) {
        ...
        if (errorMessage === 'Email already registered') {
          ...
          setError(errorMessage || 'การลงทะเบียนล้มเหลว');
        }
      } else {
    ...
    <div className="h-screen  relative overflow-hidden   bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
      ...
      <div className="relative z-10 flex items-center justify-center h-screen px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-md w-full -mt-4 sm:-mt-6 lg:-mt-10">
          ...
          {/* Registration Form with magical effects */}
          <motion.div
                ...
                >
                  ...
                  >
                    <input
                      ...
                      className="mr-2 w-4 h-4 text-cyan-400 bg-transparent border-2 border-cyan-400 focus:ring-cyan-400 focus:ring-2"
                    />
                    <span className="text-white group-hover:text-cyan-300 transition-colors font-medium">ผู้เล่น</span>
                  </motion.label>
                  <motion.label 
                    className="flex items-center cursor-pointer group"
                    whileHover={{ scale: 1.05 }}
                  ...
                  >
                    <input
                      ...
                      onChange={handleChange}
                      className="mr-2 w-4 h-4 text-green-400 bg-transparent border-2 border-green-400 focus:ring-green-400 focus:ring-2"
                    />
