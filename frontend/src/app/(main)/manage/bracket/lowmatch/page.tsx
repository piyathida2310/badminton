...
export default function TournamentBracket() {
  return (
    <div className="min-h-screen bg-[#f9f9f0] flex flex-col items-center py-10 relative overflow-hidden">
      ...
      <Link
        href="/manage/bracket"
        className="absolute bottom-10 left-10 bg-blue-500 text-white font-medium rounded-md px-6 py-2 hover:bg-gray-500 transition"
      >
