...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#194185]/5 to-[#2ED3B7]/5 py-6 px-4">
      {tournamentId ? (
            ...
            <table className="w-full text-sm leading-relaxed border-collapse">
              <tbody>
                ...
                <tr className="border-b border-[#194185]/20">
                  ...
                  <td className="p-3 bg-[#2ED3B7]/5 font-semibold text-[#194185]">
          ...
          <div className="overflow-x-auto rounded-2xl shadow-lg border bg-white">
            <table className="w-full text-sm leading-relaxed">
              <tbody>
                ...
                <tr>
                  <td className="p-3 bg-white space-y-2 h-72 overflow-y-auto whitespace-pre-line text-gray-700">
